...
| EM-003 | Repository already has deterministic and replayable design constraints. | docs/deterministic_assumptions_v1.md:L8-L13; src/smart_money/core/replay.py:L7,L75,L129,L184,L215 | SUFFICIENT_FOR_REVIEW | Identified key principles and code references. | Blocks contract approval if not grounded. |
| EM-004 | Existing immutable model conventions should guide any future raw candle contract. | src/smart_money/core/errors.py:L11; src/smart_money/core/events.py:L11; src/smart_money/core/replay.py:L39,L158,L167; docs/core_contracts_principles.md:L9 | SUFFICIENT_FOR_REVIEW | Documented use of @dataclass(frozen=True) and immutability principles. | Blocks model-shape approval. |
...
| EM-013 | Slice 1.0 must not leak reporting/UI concerns into domain contracts. | docs/architecture_boundaries.md:L7,L9-L15,L21-L23; docs/scope_guardrails.md:L34 | SUFFICIENT_FOR_REVIEW | Explicit boundaries for Core and Reporting, and a guardrail against leakage. | Blocks any user-facing/reporting fields. |

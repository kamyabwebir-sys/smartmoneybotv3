...
| EM-003 | Repository already has deterministic and replayable design constraints. | docs/deterministic_assumptions_v1.md:L8-L13; src/smart_money/core/replay.py:L7,L75,L129,L184,L215 | PARTIAL | Found some evidence for deterministic/replayable, but more specific references needed for full coverage. | Blocks contract approval if not grounded. |

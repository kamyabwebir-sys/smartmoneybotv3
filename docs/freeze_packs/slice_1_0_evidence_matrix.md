...
| EM-003 | Repository already has deterministic and replayable design constraints. | | MISSING | Need exact file and line references showing deterministic/replayable requirements. | Blocks contract approval if not fully grounded. |

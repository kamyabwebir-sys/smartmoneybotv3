...
| EM-003 | Repository already has deterministic and replayable design constraints. | docs/core_contracts_principles.md:12-14; docs/deterministic_assumptions_v1.md:8,10-12; docs/testing_strategy.md:11,15; docs/core_contract_semantics_v1.md:17-27,377-384; docs/roadmap.md:5,17-18; docs/architecture_boundaries.md:7,9-13; docs/slice_0_6_domain_contracts.md:5,15-16 | PARTIAL | Repository documentation provides explicit deterministic and replayable design constraints, but implementation-level replay evidence still needs revision-accurate grounding in the current repository state. | Blocks contract approval if implementation evidence is not fully grounded. |
| EM-004 | Existing immutable model conventions should guide any future raw candle contract. | src/smart_money/core/errors.py:L11; src/smart_money/core/events.py:L11; src/smart_money/core/replay.py:L39,L158,L167; docs/core_contracts_principles.md:L9 | MISSING | Need evidence of current immutable contract style before proposing any model shape. | Blocks model-shape approval. |
...
| EM-013 | Slice 1.0 must not leak reporting/UI concerns into domain contracts. | docs/architecture_boundaries.md:5-7,21-23; docs/deterministic_assumptions_v1.md:13,19-23; docs/roadmap.md:35,128,199,204-205,211; docs/slice_0_6_domain_contracts.md:29-30 | PARTIAL | Repository documentation explicitly separates Core/Domain truth from Reporting/UI concerns and records explicit downstream-only reporting boundaries, but implementation-level absence of leakage still requires bounded repository inspection. | Blocks any user-facing or reporting fields until implementation inspection is complete. |

...
from smart_money.application.wallet_candidate_query import query_wallet_candidates
from smart_money.application.wallet_candidate_read_model import build_wallet_candidate_read_model
from smart_money.application.wallet_ranking import rank_wallet_candidates
from smart_money.core.ids import deterministic_id


def test_wallet_candidate_query_filters_by_wallet_score_and_rank() -> None:
    identity = {
        "activity_count": 3,
        "buy_ratio_bps": 6000,
        "cohort_count": 1,
    ...
    model = build_wallet_candidate_read_model((evidence,), ranking)
    result = query_wallet_candidates(
